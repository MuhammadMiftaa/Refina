...
export default function Wallets() {
  ...
  return (
    <div className="font-poppins min-h-screen w-full px-4">
          ...
          >
            ...
            <div className="flex flex-col">
              <div className="flex flex-col text-white">
                ...
                <h2 className="-mt-1 text-xl">Muhammad Miftakul Salam</h2>
              </div>
              <div className="mt-5 flex w-full flex-row items-center justify-between text-white">
                <div>
                  ...
                  <h2 className="-mt-1 text-xl">1410-****-11281</h2>
                </div>
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                adipisci reiciendis accusamus consectetur nobis doloribus! Esse
                nostrum consectetur quas veniam at ullam possimus reiciendis
                earum molestiae error voluptatum praesentium, fuga, magni dicta
                sed iusto facilis labore repellendus dolor rerum et, laboriosam
                illo pariatur! Mollitia provident ut modi, eligendi optio
                ducimus, laboriosam, consectetur harum aut neque a. Incidunt
                eius repellendus cum dicta error iusto, dolore dolorum rem?
                Asperiores rem pariatur tempora voluptates praesentium eum
                tenetur, sapiente aliquam libero ipsa soluta, maxime officiis
                beatae itaque. Provident nostrum magnam deserunt illum labore
                ullam vero hic aut, eligendi est laudantium consectetur ipsa
                corporis placeat!
              </AccordionContent>
            </AccordionItem>
          </Accordion>
