...
// Configuration
const BASE_URL = 'https://api-refina-exp-prewarm.miftech.web.id/v1/transactions/income';
// const BASE_URL = 'http://69.62.80.249:10002/v1/transactions/income';
const AUTH_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Im1hZG1pZnRhNzdAZ21haWwuY29tIiwiZXhwIjoxNzY2Nzk5ODgxLCJpZCI6ImZkZDIxNDI0LWRlY2EtNGY2Ni04YzNhLWM4NDdmZDJjYzA4NiIsInVzZXJuYW1lIjoiTXVoYW1tYWQgTWlmdGEifQ.JSkaRE8OPTZkEjdYTPbErCZTyLWihncapdXu5M1nCYI';
...
export default function () {
  ...
  const fileSize = '1MB'; // Ukuran file: 1MB, 5MB, 10MB, 15MB

  const payload = generatePayload(testCaseNumber, scenarioName, base64Files[fileSize]);
  ...
  const params = {
    ...
    timeout: '60s', // Timeout 60 detik untuk file besar
  };
